...
export const DAG_ERROR_CODE_JSON_TOO_LARGE: string
export const DAG_ERROR_CODE_JSON_PARSE: string
/** Default maximum JSON string length accepted by [`JsDag::from_json`] (256 MiB). */
export declare function defaultMaxDagJsonBytes(): number
...
export declare class Dag {
   ...
   */
  static fromJson(s: string, maxBytes?: number | undefined | null): JsDag
}
